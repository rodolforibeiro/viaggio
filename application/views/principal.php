	...
	<header id="headprincipal">
            <div class="secondary">
				...
				<div class="col-md-3 col-sm-6 highlight">
				    <div class="h-caption"><h4><a href="<?php echo base_url();?>principal/mytrips"><i class="fa fa-globe fa-5"></i></a>My Trips</h4></div>
				...
				<div class="col-md-3 col-sm-6 highlight">
					<div class="h-caption"><h4><a href="<?php echo base_url();?>principal/routes"><i class="fa fa-random fa-5"></i></a>New Routes</h4></div>
